...
const List<List<PhotoFrame>> photoBlockFrames = [
  [PhotoFrame(0.3, 0.4),PhotoFrame(0.4, 0.4),PhotoFrame(0.3, 0.4)],
  [PhotoFrame(0.25, 0.3), PhotoFrame(0.35, 0.3),PhotoFrame(0.2, 0.3), PhotoFrame(0.2, 0.3)],
  [PhotoFrame(0.35, 0.3), PhotoFrame(0.4, 0.3),PhotoFrame(0.25, 0.3)],
];
