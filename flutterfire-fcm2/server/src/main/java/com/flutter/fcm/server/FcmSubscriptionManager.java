...
public class FcmSubscriptionManager {
  ...
  private static void subscribeFcmRegistrationTokensToTopic() throws Exception {
    List<String> registrationTokens =
        Arrays.asList(
            "dXvNplNAS7a1MQzA7VXmfy:APA91bHByaHf2VljaMo0mPEOS2zU6grYBg-Lfw2Jtn52PllyGlLmyNkHFOJ_c9RmSrv4FlX-HSLvqCmJqlq6Ji7CNXSo3vx12jNSnwexbopl8YLBIl-8qZ0"); // TODO: add FCM Registration Tokens to
    // subscribe
